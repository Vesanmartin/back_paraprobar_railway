...
class ServicioChatbot {
  ...
  async responder(pregunta, datos = {}) {
    try {
      // Construimos el contexto con los datos del negocio
        ...
        messages: [
          {
            ...
            role: 'system',
            content: `Eres un asistente de negocios para Grupo Cordillera,
                      una empresa de retail. Respondes en español, de forma
                      clara y concisa. Solo usas los datos que te entregan.
  ...
  // Convierte el objeto de datos a texto para que la IA lo entienda
  _construirContexto(datos) {
    ...
    // JSON.stringify convierte el objeto a texto legible
