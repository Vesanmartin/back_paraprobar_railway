...
CREATE TABLE `proceso_compra` (
  ...
  CONSTRAINT `proceso_compra_ibfk_1` FOREIGN KEY (`id_tercero`) REFERENCES `terceros_crm` (`id`)
...
LOCK TABLES `proceso_compra` WRITE;
/*!40000 ALTER TABLE `proceso_compra` DISABLE KEYS */;
/*!40000 ALTER TABLE `proceso_compra` ENABLE KEYS */;
UNLOCK TABLES;
